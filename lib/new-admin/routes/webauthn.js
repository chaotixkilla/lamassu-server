...
module.exports = function (app) {
  ...
  app.post('/api/generate-assertion-options', async (req, res) => {
    ...
    const userDevices = await JSON.parse((await users.getHardwareDevices(userID)).devices)
    ...
    await users.updateHardwareCredentialChallenge(userID, options.challenge)
